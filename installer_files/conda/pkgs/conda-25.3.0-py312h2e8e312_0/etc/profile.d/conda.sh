export CONDA_EXE="$(cygpath 'D:\bld\conda_1743046486868\_h_env\Scripts\conda.exe')"
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE="$(cygpath 'D:\bld\conda_1743046486868\_h_env\python.exe')"
