...
@SET "MAMBA_EXE=C:/Orion/text-generation-webui/installer_files/conda\Library\bin\mamba.exe"
@SET "MAMBA_ROOT_PREFIX=C:/Orion/text-generation-webui/installer_files/conda"
