$CONDA_EXE = 'C:/Orion/text-generation-webui/installer_files/conda/Scripts/conda.exe'
try:
    del $_CE_M
except KeyError:
    pass
try:
    ...
    pass
$CONDA_PYTHON_EXE = 'C:/Orion/text-generation-webui/installer_files/conda/python.exe'
