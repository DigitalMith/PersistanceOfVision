set -gx CONDA_EXE (cygpath "C:/Orion/text-generation-webui/installer_files/conda\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:/Orion/text-generation-webui/installer_files/conda")
set _CONDA_EXE (cygpath "C:/Orion/text-generation-webui/installer_files/conda\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:/Orion/text-generation-webui/installer_files/conda\python.exe")
