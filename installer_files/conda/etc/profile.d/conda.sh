export CONDA_EXE="$(cygpath 'C:/Orion/text-generation-webui/installer_files/conda\Scripts\conda.exe')"
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE="$(cygpath 'C:/Orion/text-generation-webui/installer_files/conda\python.exe')"
